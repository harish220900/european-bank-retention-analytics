...
<style>
    ...
    div[data-testid="stMetric"] div[data-testid="stMetricValue"] {
        color: #1A202C !important; font-weight: 700 !important; font-size: 1.8rem !important;
    }
    ...
    /* Force all plotly chart text to be dark */
    ...
    .js-plotly-plot .plotly .g-gtitle text { fill: #1A202C !important; }
...
# Rebuild derived columns after filtering (needed for groupby)
dff['EngagementProfile'] = 'Other'
dff.loc[(dff.IsActiveMember==1) & (dff.NumOfProducts>=2), 'EngagementProfile'] = 'Active Engaged'
dff.loc[(dff.IsActiveMember==1) & (dff.NumOfProducts==1), 'EngagementProfile'] = 'Active Low-Product'
dff.loc[(dff.IsActiveMember==0) & (dff.Balance>50000), 'EngagementProfile'] = 'Inactive High-Balance'
dff.loc[(dff.IsActiveMember==0) & (dff.NumOfProducts==1), 'EngagementProfile'] = 'Inactive Disengaged'
dff['RSI'] = (dff.IsActiveMember*2 + dff.NumOfProducts + dff.HasCrCard + (dff.Tenure>3).astype(int)).clip(1, 6)
dff['AgeGroup'] = pd.cut(dff.Age, bins=[0,30,40,50,60,100], labels=['<30','30-40','40-50','50-60','60+'])
dff['BalanceSeg'] = 'Zero Balance'
dff.loc[dff.Balance.between(1, 50000), 'BalanceSeg'] = '€1-50K'
dff.loc[dff.Balance.between(50001, 100000), 'BalanceSeg'] = '€50K-100K'
dff.loc[dff.Balance > 100000, 'BalanceSeg'] = '€100K+'
...
with tab1:
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            xaxis=dict(title_font=dict(color='#1A202C'), tickfont=dict(color='#1A202C')),
            yaxis=dict(title_font=dict(color='#1A202C'), tickfont=dict(color='#1A202C'))
        )
        fig.update_yaxes(gridcolor='#EDF2F7', tickfont=dict(color='#1A202C'), title_font=dict(color='#1A202C'), range=[0, max(eng_data['ChurnRate'])*1.3])
    ...
    with col2:
        ...
        fig2.update_layout(
            ...
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=360,
            title_font=dict(size=14, color='#1A202C'), showlegend=False
        )
    ...
    with col3:
        ...
        fig3.update_layout(font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=340, title_font=dict(size=14, color='#1A202C'))
    ...
    with col4:
        ...
        fig4.update_layout(
            ...
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=340, showlegend=False,
            title_font=dict(size=14, color='#1A202C')
        )
...
with tab2:
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            yaxis_title="Churn Rate (%)", xaxis_title="",
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=380, showlegend=False,
            title_font=dict(size=14, color='#1A202C')
        )
        fig.update_yaxes(gridcolor='#EDF2F7', tickfont=dict(color='#1A202C'), title_font=dict(color='#1A202C'), range=[0, 120])
        st.plotly_chart(fig, use_container_width=True)
    ...
    with col2:
        ...
        fig2.update_layout(
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=380, title_font=dict(size=14, color='#1A202C')
        )
    ...
    with col3:
        ...
        fig3 = px.imshow(
            hm_pivot, text_auto=True, color_continuous_scale='RdYlGn_r', color_continuous_midpoint=None,
            title="Churn Rate Heatmap: Products × Active Status",
            labels=dict(x="Number of Products", y="Member Status", color="Churn %"),
            aspect='auto'
        )
        fig3.update_layout(font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=320, title_font=dict(size=14, color='#1A202C'))
        st.plotly_chart(fig3, use_container_width=True)
    ...
    with col4:
        ...
        fig4.update_layout(
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=320, title_font=dict(size=14, color='#1A202C')
        )
        fig4.update_yaxes(gridcolor='#EDF2F7')
        st.plotly_chart(fig4, use_container_width=True)
...
with tab3:
    ...
    with col1:
        ...
        fig = px.bar(
            ...
            color='ChurnRate', color_continuous_scale='RdYlGn_r', color_continuous_midpoint=None,
        ...
        fig.update_layout(
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=360,
            showlegend=False, title_font=dict(size=14, color='#1A202C')
        )
        fig.update_yaxes(gridcolor='#EDF2F7', tickfont=dict(color='#1A202C'), title_font=dict(color='#1A202C'), range=[0, 45])
        st.plotly_chart(fig, use_container_width=True)
    ...
    with col2:
        ...
        fig2.update_layout(
            ...
            yaxis_title="Churn Rate (%)", xaxis_title="",
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=360, showlegend=False,
            title_font=dict(size=14, color='#1A202C')
        )
    ...
    with col4:
        ...
        fig4 = px.imshow(
            geo_pivot, text_auto=True, color_continuous_scale='RdYlGn_r', color_continuous_midpoint=None,
            title="Churn Heatmap: Geography × Activity",
            aspect='auto'
        )
        fig4.update_layout(font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=340, title_font=dict(size=14, color='#1A202C'))
        st.plotly_chart(fig4, use_container_width=True)
    ...
    fig5.update_layout(
        plot_bgcolor='white', paper_bgcolor='white',
        font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=400, title_font=dict(size=14, color='#1A202C')
    )
    ...
    if len(at_risk_df) > 0:
        ...
        with col1:
            ...
            fig = px.bar(
                ...
                color_continuous_scale='RdYlGn_r', color_continuous_midpoint=None,
            ...
            fig.update_layout(
                plot_bgcolor='white', paper_bgcolor='white',
                font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=360, title_font=dict(size=14, color='#1A202C')
            )
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig2.update_layout(font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=360, title_font=dict(size=14, color='#1A202C'))
            st.plotly_chart(fig2, use_container_width=True)
...
with tab5:
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            plot_bgcolor='white', paper_bgcolor='white',
            font=dict(family='Inter', color='#1A202C'), legend=dict(font=dict(color='#1A202C')), height=380,
            showlegend=False, title_font=dict(size=14, color='#1A202C')
        )
        fig.update_yaxes(gridcolor='#EDF2F7', tickfont=dict(color='#1A202C'), title_font=dict(color='#1A202C'), range=[0, 45])
        st.plotly_chart(fig, use_container_width=True)
